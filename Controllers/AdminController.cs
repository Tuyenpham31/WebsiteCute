...
namespace WebsiteThuCungCute.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Xoa(int id)
        {
            ...
            {
                // Xóa tất cả các phân quyền trước
                var phanquyens = data.PHANQUYENs.Where(pq => pq.MAADMIN == id);
                foreach (var pq in phanquyens)
                {
                    data.PHANQUYENs.DeleteOnSubmit(pq);
                }
        ...
        //    {
        //        ADMIN ad = data.ADMINs.SingleOrDefault(n => n.MAADMIN == id);
        //        IQueryable<PHANQUYEN> pqs = data.PHANQUYENs.Where(k => k.MAADMIN == id);
        ...
        //    {
        //        ADMIN ad = data.ADMINs.SingleOrDefault(n => n.MAADMIN == id);
        //        PHANQUYEN pq = data.PHANQUYENs.SingleOrDefault(k => k.MAADMIN == id);
        //        data.ADMINs.DeleteOnSubmit(ad);
        //        data.SubmitChanges();
        //        return RedirectToAction("listadmin", "Admin");
        //    }
